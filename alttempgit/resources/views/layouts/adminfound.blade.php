...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/media-reponsiveness.css')}}"> 
    ...
    <script src="{{asset('js/foundation-datetimepicker.js')}}"></script>
                    ...
                    <li>
                        ...
                        <li>
                            ...
                            <ul class="menu vertical nested">
                                ...
                                {{-- <li><a href="/eventstatus_found"><i class="fas fa-calendar"></i> View Event Status</a></li> --}}                                                   
                            </ul>
                        </li>
                        <li>
    ...
    <div class="grid-x">
           ...
           {{--modal change password--}}
            ...
            <div class="changepasswrdmodal-header">
                ...
                <form action="{{route('users.passchgadmin')}}" method="post"  class="form-body">
                {{-- {{method_field('patch')}} --}}
                {{csrf_field()}}
