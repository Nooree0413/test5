        ...
        <div class="grid-x">
            ...
            <div class="cell small-5 tempborder tbluser_viewordercell1">
                <select id='callbacks' size="4">
                    <?php $__currentLoopData = $foodDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foodDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option data-price='<?php echo e($foodDetail->item_price); ?>' value='<?php echo e($foodDetail->id); ?>'><?php echo e($foodDetail->item_name); ?></option>
            ...
            <div class="cell small-10">
                <fieldset class="placeorderfieldset">
                    ...
                    <form id="frmorder" class="frmorderspacing" action="" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" value="<?php echo e($get_event[0]); ?>" name="hfedeadline" id="hfedeadline">
                        ...
                        <div class="grid-x">
                            <div class="cell small-9 btncontainerplace_order"><input type="button" class="button expanded userform_btn btnfocus" name="btnsub" id="btnsub" value="Submit"></div>
