        ...
        <div class="grid-x">
            ...
            <div class="cell small-5 tempborder tbluser_viewordercell2">
                <div class="info-container transition-place_order">
                    <img class="pre-menu-img" src="<?php echo e(asset('images/sample-food.gif')); ?>" alt="Food Menu Details">
                </div>
            </div>
            <div class="cell small-1"></div>
        </div>
            ...
            <div class="cell small-10 order-div">
                <fieldset class="placeorderfieldset">
                    ...
                    <form id="frmorder" class="frmorderspacing" action="" method="POST">
                        ...
                        <input type="hidden" name="hforder_id" id="hforder_id" value="<?php echo e($order_id); ?>">
                        <table id="tblorder" class="tblplaceorderfrm table-striped">
                            <thead>
                                ...
                                <tbody id="tblorder-body">
                                    <?php $__currentLoopData = $items_not_remained; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_not_remained): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="<?php echo e($item_not_remained->id); ?>">
                                            <td>
                                                <?php echo e($item_not_remained->item_name); ?>

                                            </td>
                                            <td>
                                                <input type='number' class='qty-input' value='<?php echo e($item_not_remained->item_quantity); ?>' id='order<?php echo e($item_not_remained->id); ?>'><input type='hidden' name='hfprice<?php echo e($item_not_remained->id); ?>' id='hfprice<?php echo e($item_not_remained->id); ?>' value='<?php echo e($item_not_remained->item_price); ?>'>
                                            </td>
                                            <td hidden>order<?php echo e($item_not_remained->id); ?></td>
                                            <td><button onclick="del('<?php echo e($item_not_remained->id); ?>');" class='btndelitm' title='Remove item' type='button'><i class='fas fa-minus-square'></i> </button></td>
                                        </tr>
